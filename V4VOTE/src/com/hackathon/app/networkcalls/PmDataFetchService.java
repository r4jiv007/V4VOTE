...
import com.hackathon.contentprovider.AppContentProvider;
import com.hackathon.database.PMCandidate;

public class PmDataFetchService extends IntentService {

	public PmDataFetchService() {
		super("backEndService");
	}

	@Override
	protected void onHandleIntent(Intent intent) {
		String url = "http://192.168.43.42/vote/abc.php";
